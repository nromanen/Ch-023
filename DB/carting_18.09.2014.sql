...
CREATE TABLE `qualifying` (
  ...
  `racer_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `qualifying` VALUES (1,13,2,3,72000),(2,13,1,5,73100),(3,13,7,6,75900),(4,13,8,2,71300),(5,13,5,1,59001),(6,13,10,4,72100);
...
-- Dump completed on 2014-09-18 14:27:12
