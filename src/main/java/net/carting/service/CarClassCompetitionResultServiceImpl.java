...
public class CarClassCompetitionResultServiceImpl implements
	 ...
	 * Id of CarClassCompetitionResult by which we want to get the object.
	 * 
	 ...
	 * 
	 * @param carClassCompetition 
	 * Car class competition in which we want to calculate summary results
	 ...
	 * 
	 * @param carClassCompetition 
	 * Car class competition in which we want to recalculate summary results
