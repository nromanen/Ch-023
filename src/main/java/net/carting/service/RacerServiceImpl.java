...
public class RacerServiceImpl implements RacerService {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(RacerServiceImpl.class);
	...
	public void setDocumentToRacers(Document document, String[] racersId) {
		for (int i = 0; i < racersId.length; i++) {
			...
			if (!racersId[i].equals("-1")) {
				...
				updateRacer(racer);
				LOG.trace("Leader of team {} added '{}' to racer {} {}", racer
						.getTeam().getName(), Document
						.getStringDocumentType(document.getType()), racer
						.getFirstName(), racer.getLastName());
			}
		}
	}
