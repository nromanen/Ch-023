...
public class DataBaseDumperUtil {
    ...
    public static String dumpDB(Properties props) {
        ...
        String driverURL = props.getProperty("jdbc.databaseurl");
        ...
        try {
            ...
            String userPass=props.getProperty("jdbc.password");
            dbConn = DriverManager.getConnection(driverURL, userName, userPass);
