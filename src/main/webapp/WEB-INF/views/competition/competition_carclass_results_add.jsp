...
<form class="well" method="post" action="addRace" id="add_race_form"
	...
	<div class="form-group">
		<label path="numberOfLaps" class="text-info">Number of laps:<span class="text-danger">*</span>:&nbsp;</label> 
		<input path="numberOfLaps" name="numberOfLaps"
	...
	<input type="hidden" path="resultSequance" name="resultSequance"
	 ...
	 <div class='error'></div>
	<!--	<textarea rows=10 path="resultSequance" name="resultSequance"
		class="form-control" placeholder="Enter result sequance"
		id="result_sequance"></textarea> -->
