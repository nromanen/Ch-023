...
<div class="container row">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<strong><spring:message code="label.step" /> 1</strong>
				</h3>
			</div>
			<div class="panel-body">
				<form data-toggle="validator">
					...
					<div class="alert alert-danger" id="user_not_exist"
							style="display: none; padding: 0px 0px 0px 20px; margin-top:10px; height: 50px;">
	...
	<div class="col-md-4" id="step_2" style="display: none">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<strong><spring:message code="label.step" /> 2</strong>
				</h3>
			</div>
			<div class="panel-body">
				<form data-toggle="validator" role="form">
					...
					<input type="button" id="secure_code_btn" class="btn btn-primary" 
						value="<spring:message code="label.check_secure_code" />" />
						
					<div class="alert alert-danger" id="wrong_secure_code"
							style="display: none; padding: 0px 0px 0px 20px; margin-top: 10px; height: 50px;">
	...
	<div class="col-md-4" id="step_3" style="display: none">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<strong><spring:message code="label.step" /> 3</strong>
				</h3>
			</div>
			<div class="panel-body">
				<form data-toggle="validator" role="form">
